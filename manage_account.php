                    ...
                    <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="department_id" id="department_id" class="form-control form-control-border select2" data-placeholder="Select Account Category" >
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="curriculum_id" id="curriculum_id" class="form-control form-control-border select2" data-placeholder="Select Your Section"  >
