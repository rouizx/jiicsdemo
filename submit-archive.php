            ...
            <div class="container-fluid">
                <form action="" id="archive-form">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="img" class="control-label text-muted">Front Page of Journal Paper</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pdf" class="control-label text-muted">Journal Document (PDF File Only)</label>
