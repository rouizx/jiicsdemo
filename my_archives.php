                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="<?= base_url ?>/?page=view_archive&id=<?php echo $row['id'] ?>" target=""><?php echo ucwords($row['title']) ?>  </a></td>
                                    ...
                                    <td class="dropdown">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" href="<?= base_url ?>/?page=view_archive&id=<?php echo $row['id'] ?>" target=""><span class="fa fa-external-link-alt text-gray"></span> View</a>
