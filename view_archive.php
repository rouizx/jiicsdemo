        ...
        <div class="card card-outline card-warning shadow rounded-0">
            ...
            <div class="card-body rounded-0">
                <div class="container-fluid">
                    ...
                    <hr>
                    <center>
                        <img src="<?= validate_image(isset($banner_path) ? $banner_path : "") ?>" alt="Banner Image" id="banner-img" class="img-fluid" >
                    </center>
                    <fieldset>
                    ...
                    <fieldset>
                        <legend class="text-navy">Researchers:</legend>
                    ...
                    <fieldset>
                        ...
                        <a href="<?= isset($document_path) ? base_url.$document_path : "" ?>"  class="text-center btn btn-primary w-100 embed-responsive-item" download="">Download the Journal PDF</a>
                        
                        <?php else: ?>
                  
                  <a href="./login.php" class="text-center btn btn-primary w-100 embed-responsive-item">Download the Journal PDF</a>
